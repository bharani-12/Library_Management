...
public class library_management 
{
	...
	{ 
		...
		//Add student Details
		array[0]=new Student("Bharani",101,"B.E-CSE");
		array[1]=new Student("Azath",102,"B.E-CSE");
		array[2]=new Student("Gowtham",103,"B.E-ECE");
		...
		FileWriter fr1 = new FileWriter("x.txt", true);
		BufferedWriter br1 = new BufferedWriter(fr1);
		
		FileWriter fr2 = new FileWriter("y.txt", true);
		BufferedWriter br2 = new BufferedWriter(fr2);
		
		FileWriter fr3 = new FileWriter("z.txt", true);
		...
		while(e1==false)
		{
			...
			case 1:		//For Librarian login
				...
				else 
				{
					...
					while(e2==false)
					{
						...
						System.out.println("5. Print Books Details. ");
						System.out.println("6. Print Books in-order. ");
						...
						switch(ch2)
						{
							...
							case 3:		//To update any book
									...
									boolean z=tree.containsNode(b3);
									if(z==true)
									{
							...
							case 4:		//To Search any book

								System.out.println("\nEnter name of book:");
								String b2 = input.next();

								boolean book=tree.containsNode(b2);
								if(book==true)
								{
									int a=hashmapping.get(b2);
									System.out.println("\nSearched book is available");
									System.out.println("Name of book is: " + b2);
									System.out.println("Total Quantity of book is: " + arr[a][0]);
									System.out.println("Available Quantity of book is: " + arr[a][1]);
									System.out.println();
								}
								else{
									System.out.println("\nBook not found.\n");
							...
							case 6:	//To Print Books in-order
								   tree.printInorder();
							break;
							
							case 7://To print binary search tree
								tree.printTree();
							break;
			...
			case 2:		//For User Login
				...
				switch(ch3)
				{
					...
					case 3:		//To Search any book

						System.out.println("\nEnter name of book:");
						String b4 = input.next();

						boolean book1=tree.containsNode(b4);
						if(book1==true)
						{
							int a=hashmapping.get(b4);
							System.out.println("\nSearched book is available");
							System.out.println("Name of book is: " + b4);
							System.out.println("Total Quantity of book is: " + arr[a][0]);
							System.out.println("Available Quantity of book is: " + arr[a][1]);
							System.out.println();
						}
